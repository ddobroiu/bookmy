...
export default function Button({ children, onClick, variant = 'solid', type = 'button', className = '' }: { children: React.ReactNode; onClick?: () => void; variant?: 'solid' | 'outline'; type?: 'button' | 'submit' | 'reset'; className?: string }) {
